...
from dassl.utils import check_isfile, listdir_nohidden, setup_logger
...
if __name__ == "__main__":
    ...
    parser.add_argument("--directory", type=str, default="", help="path to directory")
    parser.add_argument(
        "--ci95", action="store_true", help=r"compute 95\% confidence interval"
    )
    parser.add_argument("--test-log", default=True, help="parse test-only logs") #action="store_true"
    parser.add_argument(
